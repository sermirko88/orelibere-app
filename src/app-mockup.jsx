...
function WelcomeScreen({ onStart }) {
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "32px 24px 28px 24px", justifyContent: "space-between", overflowY: "auto" }}>
      <div>
        <div style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.25em", color: C.brass, fontFamily: MONO_FONT, marginBottom: 14 }}>OreLibere</div>

        <PunchTicket style={{ borderRadius: 8, padding: 16, marginBottom: 16, border: "1px solid #E7C98A" }}>
          <div style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.15em", color: C.textDim, fontFamily: MONO_FONT, marginBottom: 10 }}>Un paio di scarpe</div>
          <div style={{ fontFamily: MONO_FONT, fontSize: 30, fontWeight: 800, color: C.ink, marginBottom: 14 }}>33€</div>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", backgroundColor: "rgba(78,190,141,0.12)", border: `1px solid ${C.green}`, borderRadius: 6, padding: "8px 10px" }}>
              <span style={{ fontSize: 12, color: C.ink }}>Per te</span>
              <span style={{ fontFamily: MONO_FONT, fontSize: 15, fontWeight: 800, color: C.ink }}>3h</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", backgroundColor: "rgba(255,111,111,0.12)", border: `1px solid ${C.rust}`, borderRadius: 6, padding: "8px 10px" }}>
              <span style={{ fontSize: 12, color: C.ink }}>Per un'altra persona</span>
              <span style={{ fontFamily: MONO_FONT, fontSize: 15, fontWeight: 800, color: C.ink }}>16h</span>
            </div>
          </div>
        </PunchTicket>

        <h1 style={{ fontSize: 21, fontWeight: 800, color: C.paper, fontFamily: DISPLAY_FONT, margin: "0 0 8px 0", lineHeight: 1.25 }}>
          Stesso prezzo. Vite completamente diverse.
        </h1>
        <p style={{ fontSize: 13.5, color: C.textFaint, lineHeight: 1.55, margin: "0 0 20px 0" }}>
          I 33€ sono uguali per tutti. Ma quante <strong style={{ color: C.paper }}>ore della tua vita</strong> ti costano davvero? Sai già dire cos'è superfluo e cosa no — o lo stai solo indovinando?
        </p>

        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
            <div style={{ width: 26, height: 26, borderRadius: "50%", backgroundColor: C.panel, border: `1px solid ${C.panelBorder}`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              <Calculator size={13} color={C.brass} />
            </div>
            <p style={{ fontSize: 12.5, color: C.textFaint, lineHeight: 1.5, margin: 0 }}>
              Ogni spesa che segni la vedi subito in <strong style={{ color: C.paper }}>ore del tuo lavoro</strong>, non solo in euro.
            </p>
          </div>
          <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
            <div style={{ width: 26, height: 26, borderRadius: "50%", backgroundColor: C.panel, border: `1px solid ${C.panelBorder}`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              <PiggyBank size={13} color={C.brass} />
            </div>
            <p style={{ fontSize: 12.5, color: C.textFaint, lineHeight: 1.5, margin: 0 }}>
              Imposti <strong style={{ color: C.paper }}>obiettivi di risparmio</strong> e l'app ti dice se sono realistici per te.
            </p>
          </div>
        </div>
      </div>
      ...
      <div style={{ marginTop: 20 }}>
        <p style={{ fontSize: 12, color: C.textFainter, textAlign: "center", marginBottom: 12 }}>Ci vogliono 2 minuti per impostare tutto.</p>
        <button
          onClick={onStart}
    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "24px 20px 32px 20px" }}>
      ...
      {hourly ? (
        <PunchTicket style={{ borderRadius: 8, padding: 20, border: `1px solid ${C.brass}` }}>
          ...
          <div style={{ fontFamily: MONO_FONT, fontSize: 32, fontWeight: 800, marginBottom: 8 }}>{hourly.toFixed(2)}€/ora</div>
...
function OnboardingFixed({ data, setData, onNext, onBack }) {
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "24px 20px 32px 20px", position: "relative", overflowY: "auto" }}>
      ...
      {!tooltipDismissed && (
        <div style={{ backgroundColor: "rgba(255,159,90,0.12)", border: `1px solid ${C.brass}`, borderRadius: 8, padding: "12px 14px", marginBottom: 10 }}>
      ...
      <style>{`@keyframes obPulseGlow { 0%, 100% { box-shadow: 0 0 0 0 rgba(255,159,90,0.55); } 50% { box-shadow: 0 0 0 9px rgba(255,159,90,0); } }`}</style>
      <button
        onClick={() => { setShowAdd(true); setTooltipDismissed(true); }}
        style={{
          width: "100%", padding: "12px 0", borderRadius: 4,
          border: `1px ${tooltipDismissed ? "dashed #D9BE93" : "solid " + C.brass}`,
          background: "none",
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 32 }}>
      ...
      <div style={{ padding: "0 20px", marginBottom: 12 }}>
        <div style={{ display: "flex", alignItems: "flex-start", gap: 8, backgroundColor: "rgba(255,159,90,0.12)", border: `1px solid ${C.brass}`, borderRadius: 8, padding: "10px 12px" }}>
