...
function WelcomeScreen({ onStart }) {
  const P = { fontSize: 13.5, color: C.textFaint, lineHeight: 1.65, margin: "0 0 18px 0", fontFamily: SANS_FONT };
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "32px 24px 28px 24px", overflowY: "auto" }}>
      <div style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.25em", color: C.brass, fontFamily: SANS_FONT, fontWeight: 700, marginBottom: 18 }}>OreLibere</div>

      <h1 style={{ fontSize: 26, fontWeight: 800, color: C.paper, fontFamily: DISPLAY_FONT, margin: "0 0 6px 0", lineHeight: 1.2 }}>
        Non hai mai pagato il prezzo giusto.
      </h1>
      <p style={{ fontSize: 14, color: C.textFainter, fontFamily: SERIF_FONT, fontStyle: "italic", fontWeight: 500, margin: "0 0 24px 0" }}>
        Perché hai sempre guardato il numero sbagliato.
      </p>

      <p style={P}>
        100€ sono 100€ per tutti. È un dato di fatto.<br />
        Ma per te potrebbero essere due ore di lavoro. Per un altro, un'intera giornata.<br />
        Stesso importo. Vite completamente diverse.
      </p>

      <PunchTicket style={{ borderRadius: 10, padding: 18, marginBottom: 18, border: "1px solid #EAE7E0", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          <TimeCompareBox label="Per te, due ore di lavoro" hours="2h" color={C.green} delay={80} />
          <TimeCompareBox label="Per un altro, un'intera giornata" hours="8h" color={C.rust} delay={220} />
        </div>
      </PunchTicket>

      <p style={P}>
        La striscia di numeri in banca non ti ha mai detto la verità. Ti ha solo mentito, facendoti credere che i soldi fossero l'unica risorsa da difendere.
      </p>

      <p style={P}>
        Hai sempre creduto di risparmiare, ma hai solo scambiato un'illusione con un'altra.{" "}
        <strong style={{ color: C.paper }}>La tua risorsa più preziosa non è quella che guadagni. È quella che non recuperi mai più.</strong>
      </p>

      <p style={P}>
        Non vogliamo toglierti il piacere dell'acquisto. Vogliamo solo toglierti la cecità.<br />
        Misurare le spese in euro è facile. Ma è sbagliato.
      </p>

      <p style={P}>
        L'unico modo per risparmiare davvero è capire quanto del tuo tempo stai spendendo.
      </p>

      <div style={{ marginTop: 8 }}>
        <p style={{ fontSize: 12.5, color: C.textFainter, fontFamily: SANS_FONT, lineHeight: 1.5, marginBottom: 4 }}>
          Inizia ora. Scegli quanto vale la tua ora.<br />E l'app ti dirà se puoi permettertela davvero.
        </p>
        <p style={{ fontSize: 13, color: C.brassDim, fontFamily: SANS_FONT, fontWeight: 700, marginBottom: 20 }}>
    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "24px 20px 32px 20px" }}>
      ...
      {hourly ? (
        <PunchTicket style={{ borderRadius: 8, padding: 20, border: `1px solid ${C.brass}` }}>
          <div style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.2em", color: C.textDim, fontFamily: MONO_FONT, marginBottom: 6 }}>Il tuo tempo vale</div>
      ...
      <button
        ...
        style={{
          ...
          backgroundColor: hourly ? C.brass : "#D9D4C8",
...
function OnboardingFixed({ data, setData, onNext, onBack }) {
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "24px 20px 32px 20px", position: "relative", overflowY: "auto" }}>
      ...
      {!tooltipDismissed && (
        <div style={{ backgroundColor: "rgba(248,182,45,0.12)", border: `1px solid ${C.brass}`, borderRadius: 8, padding: "12px 14px", marginBottom: 10 }}>
          <p style={{ fontSize: 12.5, color: C.paper, lineHeight: 1.5, margin: "0 0 10px 0" }}>
            👇 Tocca qui sotto per aggiungere la tua prima spesa fissa — affitto, bollette, rate, abbonamenti: tutto ciò che parte da solo ogni mese, a prescindere da quanto spendi.
          </p>
          <HoldButton
            onConfirm={() => setTooltipDismissed(true)}
            holdMs={2000}
            style={{ width: "100%", padding: "9px 0", borderRadius: 6, border: `1px solid ${C.brass}`, backgroundColor: "transparent", color: C.brass, fontSize: 11.5, fontWeight: 700 }}
          >
            Tieni premuto 2 secondi per continuare
          </HoldButton>
        </div>
      )}

      <style>{`@keyframes obPulseGlow { 0%, 100% { box-shadow: 0 0 0 0 rgba(248,182,45,0.55); } 50% { box-shadow: 0 0 0 9px rgba(248,182,45,0); } }`}</style>
      <button
        onClick={() => { setShowAdd(true); setTooltipDismissed(true); }}
        style={{
          width: "100%", padding: "12px 0", borderRadius: 4,
          border: `1px ${tooltipDismissed ? "dashed #D9D4C8" : "solid " + C.brass}`,
          background: "none",
          color: tooltipDismissed ? C.textFainter : C.brass, fontSize: 13, fontWeight: tooltipDismissed ? 400 : 700,
          display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 16, cursor: "pointer",
          animation: tooltipDismissed ? "none" : "obPulseGlow 1.6s ease-in-out infinite",
        }}
      >
      ...
      {showAdd && (
        <div style={{ position: "fixed", inset: 0, zIndex: 50, display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
          ...
          <div style={{ position: "relative", backgroundColor: C.panel, borderTop: `1px solid #D9D4C8`, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: "16px 20px 32px 20px", maxHeight: "85vh", overflowY: "auto" }}>
            <div style={{ width: 40, height: 4, backgroundColor: "#D9D4C8", borderRadius: 4, margin: "0 auto 16px auto" }} />
...
function OnboardingGoal({ data, setData, onNext, onBack }) {
  const [showAdd, setShowAdd] = useState(false);
  const [form, setForm] = useState({ nome: "", importo: "", hasDeadline: true, mesi: "12", saved: "" });
  ...
  const addGoal = () => {
    if (!form.nome || !form.importo) return;
    setData({ ...data, goals: [...goals, { id: Date.now(), nome: form.nome, importo: Number(form.importo), mesi: form.hasDeadline ? (Number(form.mesi) || 12) : null, saved: Number(form.saved) || 0 }] });
    setForm({ nome: "", importo: "", hasDeadline: true, mesi: "12", saved: "" });
    setShowAdd(false);
  };
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "24px 20px 32px 20px", position: "relative", overflowY: "auto" }}>
      ...
      <p style={{ fontSize: 13, color: C.textFainter, marginBottom: 20 }}>Facoltativo. Puoi avere più budget in parallelo — viaggio, fondo emergenza, quello che vuoi — e aggiungerne quando vuoi, anche più avanti.</p>
      ...
      <button
        ...
        style={{ width: "100%", padding: "12px 0", borderRadius: 4, border: `1px dashed #D9D4C8`, background: "none", color: C.textFainter, fontSize: 13, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 16, cursor: "pointer" }}
      >
        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 50, display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
          ...
          <div style={{ position: "relative", backgroundColor: C.panel, borderTop: `1px solid #D9D4C8`, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: "16px 20px 32px 20px", maxHeight: "85vh", overflowY: "auto" }}>
            ...
            <input
              ...
              style={{ width: "100%", backgroundColor: C.inputBg, border: `1px solid ${C.panelBorder}`, borderRadius: 4, padding: "10px 12px", color: C.paper, fontSize: 14, marginTop: 4, marginBottom: 12, outline: "none" }}
            />
            <div style={{ marginBottom: 4 }}><FieldLabel>Quanto hai già messo da parte (opzionale)</FieldLabel></div>
            <input
            ...
            >
              ...
              <div style={{ width: 38, height: 20, borderRadius: 999, backgroundColor: form.hasDeadline ? C.brass : "#D9D4C8", position: "relative", transition: "background-color 0.15s" }}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                {newMonthlyTarget > 0 ? (
                  <div style={{
                    ...
                    backgroundColor: overBudget ? "rgba(185,74,65,0.1)" : tight ? "rgba(248,182,45,0.1)" : "rgba(33,161,121,0.1)",
...
function OneTapCategorizeSheet({ tx, hourly, onClose, onConfirm }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 55, display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
      ...
      <div style={{ position: "relative", backgroundColor: C.panel, borderTop: `1px solid #D9D4C8`, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: "16px 20px 32px 20px" }}>
        <div style={{ width: 40, height: 4, backgroundColor: "#D9D4C8", borderRadius: 4, margin: "0 auto 16px auto" }} />
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      backgroundColor: isSuggested ? "rgba(248,182,45,0.12)" : C.inputBg,
...
function TransactionsScreen({ hourly, connectedAccounts, feed, setFeed, onBack, onOpenSettings, onCategorize }) {
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 96, position: "relative" }}>
      ...
      <div style={{ padding: "0 20px" }}>
        <PunchTicket style={{ borderRadius: 4, padding: 16, border: "1px solid #E3DCC8", marginBottom: 16 }}>
...
const TUTORIAL_STEPS = [
  { tab: "diario", card: { top: 348 }, tail: { dir: "up", left: 40 }, text: "Qui in alto vedi subito quante ore hai già \"speso\" oggi: viola per le spese fisse, arancio/rosso per quelle extra." },
  { tab: "diario", card: { bottom: 176 }, tail: { dir: "down", right: 36 }, text: "Tocca qui per registrare una spesa: scegli la categoria, conferma l'importo, fatto in pochi secondi." },
  { tab: "diario", card: { bottom: 96 }, tail: { dir: "down", left: "50%" }, text: "Da questa barra passi tra le sezioni dell'app. Diario, Budget e Simulatore ci sono sempre; le altre due compaiono quando servono." },
  { tab: "goal", card: { top: 100 }, tail: null, text: "Questo è Budget: qui vedi tutti i tuoi obiettivi di risparmio con l'avanzamento. Tocca \"+\" in alto per aggiungerne uno nuovo in qualsiasi momento." },
  { tab: "sim", card: { top: 100 }, tail: null, text: "Il Simulatore ti mostra il costo reale di un acquisto prima di farlo: cash, a rate senza interessi, o a rate finanziate — confronta le ore che ti costa ciascuna opzione." },
  { tab: "settings", card: { top: 340 }, tail: null, text: "Da qui colleghi banca, Revolut o PayPal. Una volta collegati, l'app ti avvisa ogni volta che spendi qualcosa, pronta da categorizzare in un tocco: è la card \"Rendiconto\" che compare in basso." },
  { tab: "diario", card: { top: 470 }, tail: null, text: "Ultima cosa: quando hai messo via qualcosa alla fine della settimana o del mese, comparirà qui in basso anche \"Chiusura\" — da lì decidi tu su quale obiettivo farlo atterrare." },
];
...
function TutorialOverlay({ step, onNext, onFinish }) {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, zIndex: 100, backgroundColor: "rgba(20,15,10,0.72)" }}>
      <div style={{
        position: "absolute", left: 20, right: 20,
        ...current.card,
        backgroundColor: C.panel, border: `1px solid ${C.brass}`, borderRadius: 10, padding: 16,
        boxShadow: "0 8px 24px rgba(0,0,0,0.4)",
      }}>
        {current.tail && (
          <div style={{
            position: "absolute", width: 0, height: 0,
            left: current.tail.left, right: current.tail.right,
            transform: typeof current.tail.left === "string" ? "translateX(-50%)" : undefined,
            ...(current.tail.dir === "up"
              ? { top: -8, borderLeft: "8px solid transparent", borderRight: "8px solid transparent", borderBottom: `8px solid ${C.brass}` }
              : { bottom: -8, borderLeft: "8px solid transparent", borderRight: "8px solid transparent", borderTop: `8px solid ${C.brass}` }),
          }} />
        )}
      ...
      <HoldButton
        onConfirm={onFinish}
        holdMs={2000}
        style={{ position: "absolute", bottom: 16, left: "50%", transform: "translateX(-50%)", padding: "9px 16px", borderRadius: 999, border: `1px solid ${C.textFaint}`, backgroundColor: "rgba(0,0,0,0.4)", color: C.textFaint, fontSize: 11 }}
      >
        Tieni premuto 2 secondi per saltare il tutorial
      </HoldButton>
    </div>
  );
}
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 96 }}>
      ...
      <div style={{ padding: "0 20px", marginBottom: 14, display: "flex", justifyContent: "center" }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 7, backgroundColor: C.panel, border: `1px solid ${C.panelBorder}`, borderRadius: 999, padding: "6px 14px" }}>
          <span style={{ fontSize: 10, color: C.textDim, textTransform: "uppercase", letterSpacing: "0.1em" }}>Il tuo tempo vale</span>
          <span style={{ fontFamily: MONO_FONT, fontSize: 13, fontWeight: 800, color: C.brass }}>{hourly.toFixed(2)}€/h</span>
        </div>
      </div>

      <div style={{ padding: "0 20px" }}>
        <PunchTicket style={{ borderRadius: 4, padding: "24px 16px", border: `1px solid #E3DCC8` }}>
          ...
          <div style={{ textAlign: "center", marginTop: 8 }}>
            {over ? (
              <p style={{ fontSize: 13, color: C.rust, fontWeight: 600, margin: 0 }}>
                Hai superato di {(spentHours - dailyHours).toFixed(1)}h ({((spentHours - dailyHours) * hourly).toFixed(0)}€) il tuo tempo disponibile
              </p>
            ) : (
              <p style={{ fontSize: 13, color: C.green, fontWeight: 600, margin: 0 }}>
                Ti restano {remaining.toFixed(1)}h ({(remaining * hourly).toFixed(0)}€) libere oggi, fisse già scalate
              </p>
            )}
          </div>
        </PunchTicket>
      ...
      <div style={{ padding: "0 20px", marginTop: 20 }}>
        <button
          ...
          style={{
            ...
            backgroundColor: "rgba(248,182,45,0.08)", borderRadius: 4, padding: 16,
      ...
      <button
        ...
        style={{
          ...
          display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 20px rgba(248,182,45,0.45)", cursor: "pointer",
        }}
      >
          ...
          <>
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 16, flexWrap: "wrap" }}>
              {[category.suggested, category.suggested ? category.suggested * 1.5 : null, category.suggested ? category.suggested * 0.6 : null]
                .filter(Boolean)
                .map((v, i) => (
                  <button key={i} onClick={() => handleAmount(v)} style={{ padding: "8px 16px", borderRadius: 999, backgroundColor: C.panelBorder, color: C.paper, fontSize: 13, fontFamily: MONO_FONT, border: "1px solid #D9D4C8", cursor: "pointer" }}>
                    {v.toFixed(2)}€
                  </button>
                ))}
            </div>
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 32 }}>
      ...
      <div style={{ padding: "0 20px", marginBottom: 12 }}>
        <div style={{ display: "flex", alignItems: "flex-start", gap: 8, backgroundColor: "rgba(248,182,45,0.12)", border: `1px solid ${C.brass}`, borderRadius: 8, padding: "10px 12px" }}>
      ...
      <div style={{ padding: "0 20px" }}>
        <PunchTicket style={{ borderRadius: 4, padding: 16, border: "1px solid #E3DCC8" }}>
      ...
      <div style={{ padding: "0 20px", marginTop: 20 }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 8, marginTop: 10, padding: "10px 12px", backgroundColor: "rgba(185,74,65,0.08)", border: `1px solid ${C.rust}`, borderRadius: 4 }}>
      ...
      <div style={{ padding: "0 20px", marginTop: 20 }}>
        <div style={{ backgroundColor: "rgba(248,182,45,0.08)", border: `1px solid ${C.brass}`, borderRadius: 4, padding: 16 }}>
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 96 }}>
      ...
      <div style={{ padding: "0 20px" }}>
        {!confirmed ? (
          <>
            <PunchTicket style={{ borderRadius: 4, padding: 16, border: "1px solid #E3DCC8", marginBottom: 14 }}>
              ...
              <>
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: allocatedTotal > 0 && remaining >= 0 ? C.brass : "#D9D4C8",
          ...
          <div style={{ backgroundColor: "rgba(33,161,121,0.1)", border: `1px solid ${C.green}`, borderRadius: 4, padding: 16, display: "flex", alignItems: "flex-start", gap: 10 }}>
    ...
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 32 }}>
      ...
      <div style={{ padding: "0 20px" }}>
                  ...
                  {acc.connectable ? (
                    <button
                      ...
                      style={{
                        ...
                        backgroundColor: connected ? "rgba(33,161,121,0.12)" : "rgba(248,182,45,0.12)",
        ...
        <button
          ...
          style={{
            width: "100%", padding: "12px 0", borderRadius: 4, border: `1px solid ${C.brass}`, backgroundColor: "rgba(248,182,45,0.08)",
            ...
            return (
              <button
                ...
                style={{
                  ...
                  backgroundColor: active ? "rgba(248,182,45,0.1)" : C.panel,
        ...
        <button
          ...
          style={{ width: "100%", padding: "12px 0", borderRadius: 4, border: `1px dashed #D9D4C8`, background: "none", color: C.textFainter, fontSize: 13, cursor: "pointer" }}
        >
      ...
      <div style={{ flex: 1, overflowY: "auto", paddingBottom: 96 }}>
        ...
        <div style={{ padding: "0 20px" }}>
          <PunchTicket style={{ borderRadius: 4, padding: 16, border: "1px solid #E3DCC8" }}>
            ...
            <div style={{ height: 8, backgroundColor: "#E3DCC8", borderRadius: 4, overflow: "hidden", marginBottom: 6 }}>
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 96 }}>
      ...
      {(overBudget || tight) ? (
        <div style={{ padding: "0 20px", marginTop: 16 }}>
          <div style={{
            ...
            backgroundColor: overBudget ? "rgba(185,74,65,0.1)" : "rgba(248,182,45,0.1)",
      ...
      <div style={{ padding: "0 20px", marginTop: 16 }}>
        <div style={{
          display: "flex", alignItems: "flex-start", gap: 10, padding: 16, borderRadius: 4,
          backgroundColor: onTrack ? "rgba(33,161,121,0.1)" : "rgba(185,74,65,0.08)",
...
function GoalListScreen({ goals, profile, hourly, onSelect, onAddGoal }) {
  ...
  const submit = () => {
    if (!form.nome || !form.importo) return;
    onAddGoal({ nome: form.nome, importo: Number(form.importo), mesi: form.hasDeadline ? (Number(form.mesi) || 12) : null, saved: Number(form.saved) || 0 });
    setForm({ nome: "", importo: "", hasDeadline: true, mesi: "12", saved: "" });
    setShowAdd(false);
  };
      ...
      <div style={{ padding: "0 20px", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ backgroundColor: C.panel, border: `1px solid ${C.panelBorder}`, borderRadius: 4, padding: 16, display: "flex", flexDirection: "column", gap: 16 }}>
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 4, borderBottom: "1px solid #D9D4C8", paddingBottom: 4 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <div>
                ...
                <input type="number" value={rata} onChange={(e) => setRata(Number(e.target.value))}
                  style={{ backgroundColor: "transparent", color: C.paper, fontFamily: MONO_FONT, fontSize: 16, width: "100%", border: "none", borderBottom: "1px solid #D9D4C8", outline: "none", marginTop: 4, paddingBottom: 4 }} />
              </div>
              <div>
        ...
        <PunchTicket style={{ borderRadius: 4, padding: 16, border: "1px solid #E3DCC8" }}>
          ...
          <div style={{ borderTop: "1px dashed #D9D4C8", paddingTop: 16 }}>
...
function MainApp({ currentUser, onChangeUser }) {
  ...
  return (
    <div style={outerStyle}>
      <div style={frameStyle}>
        {!tutorialDone && <TutorialOverlay step={tutorialStep} onNext={advanceTutorial} onFinish={skipTutorial} />}
        {syncError && (
          <div style={{ position: "absolute", top: 8, left: 8, right: 8, zIndex: 90, backgroundColor: C.rust, color: "#fff", borderRadius: 8, padding: "10px 12px", fontSize: 11.5, lineHeight: 1.4, display: "flex", alignItems: "flex-start", gap: 8 }}>
            <span style={{ flex: 1 }}>⚠ Sincronizzazione: {syncError}</span>
            <button onClick={() => setSyncError(null)} style={{ background: "none", border: "none", color: "#fff", cursor: "pointer", fontWeight: 700, padding: 0 }}>✕</button>
        ...
        {(tab === "diario" || tab === "goal" || tab === "sim" || tab === "closure" || tab === "transactions") && (
          <div style={{ borderTop: `1px solid ${C.panelBorder}`, backgroundColor: C.bg, display: "flex", alignItems: "center", justifyContent: "space-around", padding: "12px 16px" }}>
            <button onClick={() => setTab("diario")} style={{ background: "none", border: "none", display: "flex", flexDirection: "column", alignItems: "center", gap: 4, cursor: "pointer" }}>
              <Home size={20} color={tab === "diario" ? C.brass : "#B0ADA5"} />
              <span style={{ fontSize: 10, fontFamily: MONO_FONT, color: tab === "diario" ? C.brass : "#B0ADA5" }}>Diario</span>
            </button>
            {closurePool > 0 && (
              <button onClick={() => setTab("closure")} style={{ background: "none", border: "none", display: "flex", flexDirection: "column", alignItems: "center", gap: 4, cursor: "pointer", position: "relative" }}>
                <div style={{ position: "relative" }}>
                  <HandCoins size={20} color={tab === "closure" ? C.brass : "#B0ADA5"} />
                ...
                <span style={{ fontSize: 10, fontFamily: MONO_FONT, color: tab === "closure" ? C.brass : "#B0ADA5" }}>Chiusura</span>
              </button>
            )}
            {hasAnyAccountConnected && (
              <button onClick={() => setTab("transactions")} style={{ background: "none", border: "none", display: "flex", flexDirection: "column", alignItems: "center", gap: 4, cursor: "pointer", position: "relative" }}>
                <div style={{ position: "relative" }}>
                  <BarChart3 size={20} color={tab === "transactions" ? C.brass : "#B0ADA5"} />
                  {pendingTxCount > 0 && (
                    <span style={{
                ...
                <span style={{ fontSize: 10, fontFamily: MONO_FONT, color: tab === "transactions" ? C.brass : "#B0ADA5" }}>Rendiconto</span>
              </button>
            )}
            <button onClick={() => setTab("goal")} style={{ background: "none", border: "none", display: "flex", flexDirection: "column", alignItems: "center", gap: 4, cursor: "pointer" }}>
              <PiggyBank size={20} color={tab === "goal" ? C.brass : "#B0ADA5"} />
              <span style={{ fontSize: 10, fontFamily: MONO_FONT, color: tab === "goal" ? C.brass : "#B0ADA5" }}>Budget</span>
            </button>
            <button onClick={() => setTab("sim")} style={{ background: "none", border: "none", display: "flex", flexDirection: "column", alignItems: "center", gap: 4, cursor: "pointer" }}>
              <Calculator size={20} color={tab === "sim" ? C.brass : "#B0ADA5"} />
              <span style={{ fontSize: 10, fontFamily: MONO_FONT, color: tab === "sim" ? C.brass : "#B0ADA5" }}>Simulatore</span>
            </button>
          </div>
        )}
      </div>
...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.error) {
      return (
        <div style={{ minHeight: "100vh", backgroundColor: "#FDFBF7", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
          <div style={{ maxWidth: 380, backgroundColor: "#fff", border: "1px solid #EAE7E0", borderRadius: 12, padding: 20 }}>
            <div style={{ fontWeight: 800, fontSize: 15, color: "#1A1A1A", marginBottom: 8 }}>Qualcosa è andato storto</div>
            <div style={{ fontSize: 12.5, color: "#6B6B68", lineHeight: 1.5, marginBottom: 14, wordBreak: "break-word" }}>
              {String(this.state.error && this.state.error.message ? this.state.error.message : this.state.error)}
            </div>
            <button
              onClick={() => { this.setState({ error: null }); }}
              style={{ padding: "10px 16px", borderRadius: 8, border: "none", backgroundColor: "#F8B62D", color: "#1A1A1A", fontWeight: 700, cursor: "pointer" }}
            >
              Riprova
            </button>
          </div>
