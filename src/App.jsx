...
function SettingsScreen({ data, setData, onBack, onFullOnboarding, onOpenTransactions, onChangeUser, onOpenRegime, onOpenImport, onOpenImportPDF, onOpenGuida, onReplayTutorial }) {
    ...
    <div style={outerStyle}>
      <div style={frameStyle} ref={frameRef}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", position: "relative", overflow: "hidden" }}>
          ...
          {tab === "report" && <ReportScreen hourly={hourlyRate} profile={profile} onBack={() => setTab("diario")} onOpenClosure={() => (closureWindowOpen ? setTab("closure") : setShowClosureLockedInfo(true))} />}
        ...
        {(tab === "diario" || tab === "goal" || tab === "sim" || tab === "closure" || tab === "transactions" || tab === "calendario") && (
          <div id="tut-tabbar" style={{ borderTop: `1px solid ${C.panelBorder}`, backgroundColor: C.bg, display: "flex", alignItems: "center", justifyContent: "space-around", padding: "12px 16px" }}>
            ...
            {hasTier("premium") && (
              <button
                id="tut-tab-closure"
                onClick={() => (closureWindowOpen ? setTab("closure") : setShowClosureLockedInfo(true))}
              ...
              >
                <div style={{ position: "relative" }}>
                  <HandCoins size={20} color={closureWindowOpen ? (tab === "closure" ? C.brass : "#A6A29A") : "#C9C4B6"} />
                  {closureWindowOpen && closurePool > 0 && (
                ...
                <span style={{ fontSize: 10, fontFamily: MONO_FONT, color: closureWindowOpen ? (tab === "closure" ? C.brass : "#A6A29A") : "#C9C4B6" }}>Chiusura</span>
              </button>
            )}
