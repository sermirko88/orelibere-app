  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 96 }}>
      ...
      <div style={{ padding: "0 20px", marginBottom: 14, display: "flex", justifyContent: "center" }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 7, backgroundColor: "rgba(255,107,74,0.1)", border: `1px solid ${C.brass}`, borderRadius: 999, padding: "6px 8px 6px 14px" }}>
          <span style={{ fontSize: 10, color: C.textDim, textTransform: "uppercase", letterSpacing: "0.1em" }}>La tua ora di lavoro vale</span>
          <span style={{ fontFamily: MONO_FONT, fontSize: 13, fontWeight: 800, color: C.brassDim }}>{hourly.toFixed(2)}€/h</span>
          {rateSource && (
      ...
      <div style={{ padding: "0 20px" }}>
        <PunchTicket id="tut-gauge" variant="dark" style={{ borderRadius: 16, padding: "26px 18px", border: "none" }}>
          <SpendingBar fixedHours={fixedHours} extraHours={extraHours} capHours={dailyHours} hourly={hourly} dark />
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16, marginTop: 12, marginBottom: 4 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <span style={{ width: 10, height: 10, borderRadius: "50%", backgroundColor: "#7C8797", display: "inline-block" }} />
              <span style={{ fontSize: 11, color: "rgba(247,243,234,0.6)" }}>Fisse {fixedHours.toFixed(1)}h</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <span style={{ width: 10, height: 10, borderRadius: "50%", backgroundColor: C.brass, display: "inline-block" }} />
              <span style={{ fontSize: 11, color: "rgba(247,243,234,0.6)" }}>Extra {extraHours.toFixed(1)}h</span>
            </div>
          </div>
          {over ? (
            <div style={{ textAlign: "center", marginTop: 8 }}>
              <p style={{ fontSize: 13, color: "#FF8A70", fontWeight: 600, margin: 0 }}>
...
function ReportScreen({ hourly, profile, onBack, onOpenClosure }) {
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 32 }}>
      ...
      <div style={{ padding: "0 20px" }}>
        <PunchTicket variant="dark" style={{ borderRadius: 16, padding: 20, border: "none" }}>
          <div style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.2em", color: "rgba(247,243,234,0.55)", fontFamily: MONO_FONT, marginBottom: 6 }}>Tempo extra totale</div>
          <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
            <div style={{ fontFamily: MONO_FONT, fontSize: 32, fontWeight: 800 }}>{totalHours.toFixed(1)}h</div>
            <div style={{ fontFamily: MONO_FONT, fontSize: 14, color: "rgba(247,243,234,0.6)" }}>{totalEuro.toFixed(0)}€</div>
          </div>
          <div style={{ fontFamily: MONO_FONT, fontSize: 13, color: worse ? "#FF8A70" : "#9BD65C", fontWeight: 700, marginTop: 4 }}>
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 96 }}>
      ...
      <div style={{ padding: "0 20px" }}>
        {!confirmed ? (
          <>
            <PunchTicket variant="dark" style={{ borderRadius: 16, padding: 20, marginBottom: 14, border: "none" }}>
              <div style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.2em", color: "rgba(247,243,234,0.55)", fontFamily: MONO_FONT, marginBottom: 6 }}>Disponibile da distribuire</div>
              <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
                <div style={{ fontFamily: MONO_FONT, fontSize: 32, fontWeight: 800 }}>{pool}€</div>
                <div style={{ fontFamily: MONO_FONT, fontSize: 13, color: "rgba(247,243,234,0.6)" }}>{euroToTime(pool, hourly)}</div>
              </div>
              <div style={{ fontSize: 11.5, color: "rgba(247,243,234,0.7)", marginTop: 6, lineHeight: 1.4 }}>
...
function CalendarioScreen({ calendario, setCalendario, hourlyEstimate, progetti, setProgetti, redditoTipo }) {
        ...
        right={
          redditoTipo === "variabile" ? (
            hasTier("elite") ? (
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6, border: `1px solid ${C.panelBorder}`, borderRadius: 999, padding: "6px 12px" }}>
  ...
  if (!mesi) {
    ...
    return (
      <div style={{ flex: 1, overflowY: "auto", paddingBottom: 96 }}>
        ...
        <div style={{ padding: "0 20px" }}>
          <PunchTicket variant="dark" style={{ borderRadius: 16, padding: 20, border: "none" }}>
            <div style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.2em", color: "rgba(247,243,234,0.55)", fontFamily: MONO_FONT, marginBottom: 6 }}>Accumulato</div>
            <div style={{ display: "flex", alignItems: "baseline", gap: 10, marginBottom: 10 }}>
              <div style={{ fontFamily: MONO_FONT, fontSize: 32, fontWeight: 800 }}>{saved.toFixed(0)}€</div>
              <div style={{ fontFamily: MONO_FONT, fontSize: 14, color: "rgba(247,243,234,0.6)" }}>/ {importo.toFixed(0)}€</div>
            </div>
            <div style={{ height: 8, backgroundColor: "rgba(247,243,234,0.18)", borderRadius: 4, overflow: "hidden", marginBottom: 6 }}>
              <div style={{ height: "100%", backgroundColor: C.brass, width: `${pct}%` }} />
            </div>
            <div style={{ fontSize: 12, color: "rgba(247,243,234,0.6)" }}>{pct.toFixed(0)}% del percorso · {remainingHours.toFixed(0)}h ({remainingEuro.toFixed(0)}€) ancora da mettere via</div>
          </PunchTicket>
        </div>
    ...
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 96 }}>
      ...
      <div style={{ padding: "0 20px" }}>
        <PunchTicket variant="dark" style={{ borderRadius: 16, padding: 20, border: "none" }}>
          ...
          <div style={{ fontSize: 12, color: "rgba(247,243,234,0.6)" }}>{pct.toFixed(0)}% del percorso completato</div>
        </PunchTicket>
      </div>
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 96 }}>
      ...
      <div style={{ padding: "0 20px", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <PunchTicket variant="dark" style={{ borderRadius: 16, padding: 20, border: "none" }}>
          <div style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.2em", color: "rgba(247,243,234,0.55)", fontFamily: MONO_FONT, marginBottom: 12 }}>Il costo reale</div>

          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 8 }}>
            <span style={{ fontSize: 13, color: "rgba(247,243,234,0.6)" }}>
          ...
          {modo === "paypal3" && (
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 8 }}>
              <span style={{ fontSize: 13, color: "rgba(247,243,234,0.6)" }}>{numRateMostrate} rate da</span>
              <span style={{ fontFamily: MONO_FONT, fontSize: 14 }}>{rataMostrata.toFixed(0)}€/mese</span>
            </div>
          )}

          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 16 }}>
            <span style={{ fontSize: 13, color: "rgba(247,243,234,0.6)" }}>di cui interessi</span>
            {interessi > 0 ? (
              <span style={{ fontFamily: MONO_FONT, fontSize: 14, color: "#FF8A70" }}>+{interessi.toFixed(0)}€</span>
            ) : (
              <span style={{ fontFamily: MONO_FONT, fontSize: 13, color: "#9BD65C", fontWeight: 700 }}>zero</span>
            )}
          </div>

          <div style={{ borderTop: "1px dashed rgba(247,243,234,0.2)", paddingTop: 16 }}>
            <div style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.2em", color: "rgba(247,243,234,0.55)", fontFamily: MONO_FONT, marginBottom: 4 }}>Il tuo tempo</div>
            <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
              <div style={{ fontFamily: MONO_FONT, fontSize: 30, fontWeight: 800 }}>{Math.round(oreReali)}h</div>
              <div style={{ fontFamily: MONO_FONT, fontSize: 15, color: "rgba(247,243,234,0.6)" }}>≈ {euroToDaysHours(costoTotale, hourly)}</div>
            </div>
            {modo === "finanziato" ? (
              <div style={{ fontSize: 12, color: "rgba(247,243,234,0.7)", marginTop: 4 }}>
                vs {Math.round(oreCash)}h se pagato subito — <span style={{ color: "#FF8A70", fontWeight: 700 }}>{Math.round(oreDiff)}h in più</span> per gli interessi
              </div>
            ) : modo === "paypal3" ? (
              <div style={{ fontSize: 12, color: "#9BD65C", marginTop: 4 }}>
