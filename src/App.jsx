...
function buildTutorialSteps(isVariabile) {
  const steps = [
    ...
    { tab: "diario", targetId: "tut-tabbar", radius: 12, text: "Da questa barra passi tra le sezioni dell'app. Diario, Calendario, Simulatore e Budget ci sono sempre; le altre due compaiono quando servono." },
  ];
