    ...
    <div style={{ width: "100%" }}>
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 16, gap: 12 }}>
        <div style={{ display: "flex", flexDirection: "column" }}>
          <span style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.12em", color: C.textFaint, marginBottom: 4 }}>Ore spese oggi</span>
          <span style={{ fontFamily: SERIF_FONT, fontSize: 30, fontWeight: 700, letterSpacing: "-0.01em", color: over ? C.rust : C.ink }}>{spentHours.toFixed(1)}h</span>
          {hourly ? <span style={{ fontSize: 11.5, color: C.textDim, fontFamily: MONO_FONT, marginTop: 2 }}>≈ {(spentHours * hourly).toFixed(0)}€</span> : null}
        </div>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
          <span style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.12em", color: C.textFaint, marginBottom: 4 }}>Ore disponibili</span>
          <span style={{ fontFamily: SERIF_FONT, fontSize: 30, fontWeight: 700, letterSpacing: "-0.01em", color: C.green }}>{remainingHours.toFixed(1)}h</span>
          {hourly ? <span style={{ fontSize: 11.5, color: C.textDim, fontFamily: MONO_FONT, marginTop: 2 }}>≈ {(remainingHours * hourly).toFixed(0)}€</span> : null}
        </div>
      </div>
      <div style={{ position: "relative", width: "100%", height: 18, borderRadius: 999, backgroundColor: "rgba(23,23,23,0.08)", overflow: "hidden", display: "flex" }}>
        <div style={{ width: `${fixedPct}%`, backgroundColor: C.fixedBar, transition: "width 0.6s ease" }} />
        <div style={{ width: `${extraPct}%`, backgroundColor: extraColor, transition: "width 0.6s ease, background-color 0.3s ease" }} />
        <div style={{ width: `${remainingPct}%`, backgroundColor: "rgba(124,179,66,0.35)", transition: "width 0.6s ease" }} />
      </div>
